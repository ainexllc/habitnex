            ...
            <CardContent>
              <div className="grid md:grid-cols-3 gap-8 text-center">
                <div>
                  ...
                  <h4 className="font-bold text-gray-900 mb-2">Create Your Family</h4>
                  <p className="text-gray-600">Set up your family name and get an invite code to share</p>
                </div>
                <div>
                  ...
                  <p className="text-gray-600">Share the code with everyone who wants to join your family</p>
                </div>
                <div>
                  <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <span className="text-2xl font-bold text-purple-600">3</span>
                  </div>
                  <h4 className="font-bold text-gray-900 mb-2">Track Together</h4>
                  <p className="text-gray-600">See everyone's progress and celebrate wins together</p>
                </div>
              </div>
            </CardContent>
          </Card>
